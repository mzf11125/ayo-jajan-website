      ...
      <div className="container">
        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Track Vendors</h3>
            <p className="text-gray-600">Find live locations of your favorite street food carts using real-time GPS</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Start Challenges</h3>
            <p className="text-gray-600">Complete food missions like "Try 5 Street Noodles" to earn rewards</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Eco Actions</h3>
            <p className="text-gray-600">Get bonus points for sustainable choices like using reusable containers</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">Post your finds and join a global community of street food explorers</p>
          </div>
        </div>
      </div>
    </section>
